...
if (isset($_GET['updateid'])) {
    ...
    $query = "SELECT * FROM comenzi WHERE comandaID = $id";
...
if(isset($_POST['submit'])){
    ...
    if (mysqli_num_rows($clientresult) > 0 && mysqli_num_rows($produsresult) > 0){
        $sql = "UPDATE comenzi SET clientID='$clientID', produsID='$produsID', dataComanda='$dataC', cantitate='$cantitate' WHERE comandaID='$id'";
        ...
        echo "<script>alert('ID-ul clientului sau ID-ul produsului nu exista in baza de date!');</script>";
    }
}
?>
...
<div class="formular">
    <form method="post">
        ...
        <input type="text"  name="clientID" value="<?php echo $clientID; ?>" placeholder="Introdu id client..." required>
        ...
        <input type="text"  name="dataComanda"  value="<?php echo $dataC; ?>" placeholder="Format data expirare(YYYY-MM-DD)..." required>
