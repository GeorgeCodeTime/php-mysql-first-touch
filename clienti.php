...
<body>
<div class=topbar>
    <a class="buttonNavigare" style="background-color:#5D6D7E;" href="clienti.php">Clienti</a>
...
<a class="button" href="adaugaclient.php">Adauga client</a>
                ...
                if($result){
                    while($row=mysqli_fetch_assoc($result)){
                        ...
                        if ($_SESSION['tip'] == 'admin') {
                            echo '<a class="delButton" href="stergeclienti.php?deleteid='.$id.'">Sterge</a>';
                        }
                        
                        echo '<a class="editButton" href="editclienti.php?updateid='.$id.'">Editeaza</a>';
