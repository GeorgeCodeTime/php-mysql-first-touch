...
if(isset($_POST['submit'])){
    ...
    if (mysqli_num_rows($producatorresult) > 0 && mysqli_num_rows($produsresult) > 0){
        $sql = "INSERT INTO expedieri (produsID,producatorID,dataExpediere,cantitate) VALUES ('$produsID','$producatorID','$dataE','$cantitate')";
        ...
        echo "<script>alert('ID-ul producatorului sau ID-ul produsului nu exista in baza de date!');window.location.href='adaugaexpediere.php';</script>";
    }
}
?>
...
<div class="formular">
    <form method="post">
        ...
        <input type="text"  name="producatorID" placeholder="Introdu id producator..." required>

        <label for="adresa">Data comanda:</label>
        <input type="text"  name="dataExpediere" placeholder="Format data expediere(YYYY-MM-DD)..." required>
